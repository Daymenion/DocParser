...
# ==================== Configuration ====================
# Run backend with Hugging Face by default
USE_HF_BACKEND = True
...
def process_image_inference(session_state, test_image_input, file_input,
    ...
    try:
        if file_ext == '.pdf':
            ...
            backend_info = "Backend: HF local" if dots_parser.use_hf else f"Server: {current_config['ip']}:{current_config['port_vllm']}"
